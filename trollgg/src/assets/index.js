export const champList = {
  ...
  data: {
    ...
    Quinn: {
      ...
      title: "데마시아의 날개",
      blurb:
        "데마시아의 정예 기동대원이자 기사인 퀸은 전설적인 독수리 발러와 함께 적의 영토 한복판에 잠입해 갖가지 위험한 임무를 수행한다. 퀸과 발러의 강력한 결속력은 전투에서 무시무시한 힘을 발휘한다. 적들은 그들의 상대가 데마시아 제일가는 영웅, 그것도 하나가 아니라 둘이라는 사실을 알지도 못한 채 순식간에 목숨을 잃고 만다. 상황에 따라 곡예 수준의 동작을 보여주는 퀸이 민첩한 몸놀림으로 석궁을 꺼내들면, 발러는 공중에서 유영하며 숨어 있는 적을 찾아낸다...",
    ...
    Volibear: {
      ...
      title: "울부짖는 천둥",
      blurb:
        "천 번 찔린 곰이라 불리는 번개의 반신 볼리베어는 프렐요드의 전쟁전문가이다. 수천 년 동안 끝도 없이 이어진 지독한 전쟁에서, 그것도 혹한의 겨울에서 무수한 전투를 치르면서, 진정한 불굴의 위력을 갖게 되었다. 볼리베어는 산 꼭대기에서 번개 화살을 적에게 퍼붓는데, 광폭한 눈보라가 잠잠해졌다고 해도 안심해선 안 된다. 볼리베어가 한 번 더 공격할 것이라는 예고편일 뿐이니. 정 볼리베어를 직접 보고 싶다면 용맹한 어사인 전사의 부대에 입대하는 방법이...",
